	...
	return (
		<DialogPortal data-slot="dialog-portal">
			...
			<DialogPrimitive.Content
				...
				className={cn(
					"bg-background/95 backdrop-blur-md       fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-6 rounded-2xl border border-border/50 p-8 shadow-none duration-200 sm:max-w-lg",
					className,
				)}
				{...props}
			>
